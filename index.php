                        ...
                        <div class="text-white flex flex-col">
                            ...
                            <div class="flex flex-col space-y-2">
                                <div class="flex items-center">
                                    ...
                                    <span id="numberOfReplacement-value"
                                        class="text-black text-sm ml-20 mt-10 ">5</span>
                                </div>
                                <input id="numberOfReplacement" name="numberOfReplacement" type="range" value="5"
                            ...
                            <div class="flex flex-col space-y-2">
                                ...
                                <input id="chanceOfMistake" name="chanceOfMistake" type="range" value="5" min="0"
                                    max="50" step="1" class="w-full accent-orange-700"
                                    oninput="document.getElementById('chanceOfMistake-value').textContent = this.value">
                            </div>
                        </div>
                    </div>
                    <button type="submit"
                        class="mt-4 w-full bg-orange-700 text-white py-2 rounded-lg hover:bg-orange-700" name="form">
                        Confirm
                    </button>
                </div>
            </form>
